...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        selectedSquares.push(squareNumber + actuvePlayer);
...
//placement sound ('./media/place.mp3' for example), and plays the audio.
...
//This function resets the game in a draw situation or win situation.
function resetGame() {
